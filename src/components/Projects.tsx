  ...
  return (
    <section id="projects" className="py-20 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-fg mb-3">{t('projects.title')}</h2>
          <p className="text-fg-muted">{t('projects.subtitle')}</p>
        </div>
          ...
          <div className="flex items-center gap-2 ml-4 shrink-0">
            {project.github && (
              <a href={project.github} target="_blank" rel="noreferrer"
                className="text-fg-disabled hover:text-fg-2 transition-colors" aria-label="GitHub">
                <GithubIcon size={16} />
              </a>
            )}
            {project.npm && (
              <a href={project.npm} target="_blank" rel="noreferrer"
                className="text-fg-disabled hover:text-fg-2 transition-colors" aria-label="npm">
                <Package size={16} />
              </a>
            )}
            {project.href && (
              <a href={project.href} target="_blank" rel="noreferrer"
                className="text-fg-disabled hover:text-fg-2 transition-colors" aria-label="Live site">
