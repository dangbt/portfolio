...
export function Blog() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-20">
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-fg mb-3">{t('blog.title')}</h1>
        <p className="text-fg-muted">{t('blog.subtitle')}</p>
      </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    ...
                    <span className="text-xs text-fg-disabled">
                      {new Date(post.date).toLocaleDateString(i18n.language === 'vi' ? 'vi-VN' : 'en-US', {
